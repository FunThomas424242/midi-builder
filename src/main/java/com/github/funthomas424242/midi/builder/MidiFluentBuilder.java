...
public class MidiFluentBuilder {
    ...
    public MidiFluentBuilder(final String vorname, final String name, final int geburtsjahr, final int geburtsmonat, final int geburtstag) {
